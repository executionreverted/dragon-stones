...
abstract contract ONFT721CoreUpgradeableEnumerable is NonblockingLzAppUpgradeable, ERC165Upgradeable, IONFT721CoreUpgradeable, ERC721EnumerableUpgradeable {
    ...
    //}
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721EnumerableUpgradeable, ERC165Upgradeable, IERC165Upgradeable) returns (bool) {
        return interfaceId == type(IONFT721CoreUpgradeable).interfaceId || super.supportsInterface(interfaceId);
    }
