...
import "./IONFT721UpgradeableEnumerable.sol";
import "../IONFT721Upgradeable.sol";
import "./ONFT721CoreUpgradeableEnumerable.sol";

// NOTE: this ONFT contract has no public minting logic.
// must implement your own minting logic in child classes
contract ONFT721UpgradeableEnumerable is Initializable, ONFT721CoreUpgradeableEnumerable, IONFT721UpgradeableEnumerable {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ONFT721CoreUpgradeableEnumerable, IERC165Upgradeable) returns (bool) {
